...
SELECT 'Uncategorized', category_types.type 
FROM (SELECT DISTINCT type FROM categories) category_types
WHERE NOT EXISTS (
  SELECT 1 FROM categories c2 
  WHERE c2.name = 'Uncategorized' AND c2.type = category_types.type
);
