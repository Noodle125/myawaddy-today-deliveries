-- Fix search path for the safe delete functions
DROP FUNCTION IF EXISTS public.safe_delete_category(uuid);
DROP FUNCTION IF EXISTS public.safe_delete_product(uuid);

-- Create function to safely delete categories with proper search path
...
-- Create function to safely delete products with proper search path
